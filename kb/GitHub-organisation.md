...
> **Même entité, autre type** : [[kb/GitHub-technologie\|GitHub (TECHNOLOGIE)]]

## Attributs

- **rôle** : Éditeur de Copilot, cité comme point de comparaison tarifaire
...
- [[kb/_entites-mineures#GitHub-Spark\|GitHub Spark]] (TECHNOLOGIE) — 0.97, STATIQUE
...
- [[kb/Gemini-CLI\|Gemini CLI]] **utilise** → GitHub — 0.99
- [[kb/n8n-workflows\|n8n-workflows]] **utilise** → GitHub — 0.99
...
- [[kb/Buzz-Projects\|Buzz Projects]] **concurrence** → GitHub — 0.86
