...
- [[kb/_entites-mineures#Enduring-Principle\|Enduring Principle]] — définition: Principe de sécu durable (vs implémentation périssable, car les modèles évoluent) (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#cohérence-d'empreinte\|cohérence d'empreinte]] — définition: Exigence selon laquelle une empreinte falsifiée doit l'être sur toutes les surfaces liées et sur aucune autre — corriger trop est aussi détectable que corriger trop peu (1 occ., 1 fiches)
...
- [[kb/open-weights\|open-weights]] — lecture géopolitique (Ball): Intrinsèquement décélérationnistes : dissuadent le capex IA et créent un « voile d'ingouvernabilité » sur l'IA ; leur généralisation mènerait au « communisme de l'IA » (3 occ., 3 fiches)
