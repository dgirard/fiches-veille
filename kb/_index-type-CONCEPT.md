...
- [[kb/_entites-mineures#Shadow-AI\|Shadow AI]] — définition: Usage massif de l'IA par les employés sans déclaration au management (1 occ., 1 fiches)
...
- [[kb/token\|token]] — définition: Unité économique de l'IA générative — chiffre entre 0 et ~65000 représentant quelques lettres, pixels ou son. 1 token ≈ une syllabe. 100 tokens ≈ une ligne de code (1 occ., 1 fiches)
