...
- [[kb/AGI\|AGI]] — statut_selon_Julia: Non réalisable avec approches actuelles (3 occ., 3 fiches)
...
- [[kb/_entites-mineures#Context-Rot\|Context Rot]] — définition: Dégradation de performance quand le contexte grandit, attention diluée sur trop de tokens (2 occ., 2 fiches)
...
- [[kb/subagents\|subagents]] — usage: Instances Claude parallèles se challengeant mutuellement pour code review (2 occ., 2 fiches)
