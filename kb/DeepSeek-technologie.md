...
> **Type** : TECHNOLOGIE | 7 relations | 5 fiches sources

> **Même entité, autre type** : [[kb/DeepSeek-organisation\|DeepSeek (ORGANISATION)]]

## Attributs

- **catégorie** : Modèle open-weights chinois (part doublée sur OpenRouter)

## Relations (comme sujet)

### affirme_que

- « la nouvelle grille tarifaire de l'API entre en vigueur le 16 août 2026 à 16:00 UTC avec des tarifs heures pleines et heures creuses, les heures creuses étant 50 % moins chères que les heures pleines » (MESURE) — 0.92, DYNAMIQUE
...
- modèles américains de pointe (TECHNOLOGIE) — 0.85, DYNAMIQUE
...
- « -40% depuis le pic de février 2025 sur le web » (MESURE) — 0.90, STATIQUE
...
- [[kb/DeepSeek-V3.2-Exp\|DeepSeek-V3.2-Exp]] (TECHNOLOGIE) — 0.99, STATIQUE
...
- [[kb/DeepSeek-Harness\|DeepSeek Harness]] (TECHNOLOGIE) — 0.98, STATIQUE
  - [[fiches/2026-08/deepseek-harness-everything-is-a-plugin-2026-08-13\|DeepSeek Harness developer preview: Everything is a plugin]]
