...
- [[kb/goose\|Goose]] **utilise** → MCP-UI — 0.97
- [[kb/Shopify\|Shopify]] **utilise** → MCP-UI — 0.97
- [[kb/_entites-mineures#Ido-Salomon\|Ido Salomon]] **a_créé** → MCP-UI — 0.95
- [[kb/Liad-Yosef\|Liad Yosef]] **a_créé** → MCP-UI — 0.95
- [[kb/_entites-mineures#Hugging-Face\|Hugging Face]] **utilise** → MCP-UI — 0.95
- [[kb/_entites-mineures#spectrum-de-communication\|spectrum de communication]] **fait_partie_de** → MCP-UI — 0.92
- [[kb/_entites-mineures#Andrew-Harvard\|Andrew Harvard]] **améliore** → MCP-UI — 0.85
