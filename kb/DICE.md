...
- **définition** : Domain-Integrated Context Engineering — extension du context engineering intégrant un modèle de domaine pour structurer inputs et outputs LLM
