...
- **origine** : Économie classique, William Stanley Jevons (1865) — appliqué ici au code généré

## Relations (comme sujet)

### prédit

- « demande infinie quand cout execution tend vers zero » (AFFIRMATION) — 0.90, ATEMPOREL
...
- code généré par IA (CONCEPT) — 0.92, ATEMPOREL
