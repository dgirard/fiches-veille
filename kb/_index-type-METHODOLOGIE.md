...
- [[kb/SDLC\|SDLC]] — phases: Définir → construire → vérifier → déployer → maintenir (invariant) (1 occ., 1 fiches)
...
- [[kb/context-engineering\|context engineering]] — définition: Art et science de remplir la fenêtre de contexte LLM avec les bonnes informations (définition Karpathy) (3 occ., 3 fiches)
...
- [[kb/vibe-coding\|vibe coding]] — définition: coder au feeling avec l'IA sans cadre structuré (20 occ., 19 fiches)
