...
> 155 entités de type METHODOLOGIE
...
- [[kb/Harness-engineering\|Harness engineering]] — catégorie: Pratique d'ingénierie pour construire la confiance dans les agents de codage (2 occ., 2 fiches)
...
- [[kb/_entites-mineures#Ralph-Loop\|Ralph Loop]] — définition: Pattern de harnais réinjectant le prompt dans un contexte propre pour forcer la continuation (1 occ., 1 fiches)
...
- [[kb/Vibe-Coding\|Vibe Coding]] — définition: Développement assisté par orchestration agentique (9 occ., 8 fiches)
