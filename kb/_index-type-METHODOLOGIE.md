...
> 358 entités de type METHODOLOGIE
...
- [[kb/Loop-Engineering\|Loop Engineering]] — définition: Concevoir un système qui s'améliore à chaque run via des boucles à 5 parties (trigger, action, preuve, mémoire, stop) (1 occ., 1 fiches)
...
- [[kb/SDLC\|SDLC]] — phases: Définir → construire → vérifier → déployer → maintenir (invariant) (2 occ., 2 fiches)
...
- [[kb/_entites-mineures#orchestration-d'agents\|orchestration d'agents]] — rôle: Connaître les modes d'échec des agents, les chaîner, rattraper une erreur avant propagation (1 occ., 1 fiches)
