...
- [[kb/Gemini\|Gemini]] (TECHNOLOGIE) — 0.99, STATIQUE
...
- « les prompts et code des utilisateurs Standard/Enterprise ne sont pas collectés » (AFFIRMATION) — 0.99, DYNAMIQUE
...
- « les prompts et code des utilisateurs de l'API Developer payante ne sont pas collectés » (AFFIRMATION) — 0.97, DYNAMIQUE
  - [[fiches/2025-04/gemini-cli-tos-privacy-google-2025-04-17\|Gemini CLI - Terms of Service - Privacy - Google - Data collection - Model training - Authentication]]
...
- « hausse Gemini 20-45% » (MESURE) — 0.95, STATIQUE
...
- [[kb/AI-Mode\|AI Mode]] (TECHNOLOGIE) — 0.99, STATIQUE
  - [[fiches/2025-03/google-ai-mode-search-personalized-sites-2025-03-05\|Google AI Mode - Search transformation - Personalized sites - Generative search - Web génératif]]
- [[kb/Code-Wiki\|Code Wiki]] (TECHNOLOGIE) — 0.99, STATIQUE
...
- [[kb/Windsurf\|Windsurf]] **fait_partie_de** → Google — 0.93
