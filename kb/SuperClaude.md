...
- **catégorie** : Framework de configuration meta-programming
- **licence** : MIT open source
- **popularité** : 17.7k étoiles GitHub
- **version** : v4.2 (Deep Research) / v2.0 (plugins TypeScript)
...
- [[kb/_entites-mineures#SuperClaude-Org\|SuperClaude-Org]] **publie** → SuperClaude — 0.97
- [[kb/_entites-mineures#NomenAK\|NomenAK]] **dirige** → SuperClaude — 0.85
