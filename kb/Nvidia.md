...
- **positionnement** : Constructeur de datacenters complets (GPU + logiciels + réseaux)
- **secteur** : Partenaire technologique Campus IA, fournisseur GPU mondial
...
- [[kb/OpenAI\|OpenAI]] (ORGANISATION) — 0.95, DYNAMIQUE
...
- [[kb/_entites-mineures#DGX-Spark\|DGX Spark]] (TECHNOLOGIE) — 0.99, STATIQUE
  - [[fiches/2025-10/greyling-nvidia-software-ecosystem-dominance-2025-10-30\|Nvidia stratégie software, SLMs workflows agentiques, Nemotron Nano, DGX Spark workstation, data flywheel fine-tuning, hardware moat, vision-RAG - Cobus Greyling - Medium]]
...
- [[kb/_entites-mineures#tokens\|tokens]] (CONCEPT) — 0.75, DYNAMIQUE
...
- [[kb/OpenAI\|OpenAI]] **investit_dans** → Nvidia — 0.95
