...
- « 80-90 % de la campagne réalisée par l'IA » (MESURE) — 0.98, STATIQUE
  - [[fiches/2025-11/anthropic-disrupting-ai-espionage-2025-11-13\|Première campagne cyber espionnage orchestrée par IA - Claude Code manipulé - Acteur État chinois - 30 cibles globales - 80-90% automatisé - Jailbreaking - Anthropic Threat Intelligence]]
- « 90-100% du code écrit chez Cherny » (MESURE) — 0.96, DYNAMIQUE
  - [[fiches/2026-02/cherny-yc-lightcone-claude-code-origin-story-2026-02\|Boris Cherny raconte la genèse de Claude Code, philosophie produit et conseils fondateurs - Y Combinator Light Cone]]
- « 1 milliard $ revenus annualisés » (MESURE) — 0.95, STATIQUE
  - [[fiches/2026-02/maitriser-claude-code-formation-pedagogique-deep-research-2026-02\|Formation complète Claude Code : 12 modules pédagogiques coding agentique - Deep Research]]
- « 500M$ de revenus annuels » (MESURE) — 0.95, DYNAMIQUE
  - [[fiches/2025-09/how-claude-code-is-built-pragmatic-engineer-2025-09-15\|Construction de Claude Code - Architecture IA-first - Ingénierie produit - Pragmatic Engineer]]
- « 4% des commits publics mondiaux » (MESURE) — 0.85, DYNAMIQUE
  - [[fiches/2026-02/cherny-yc-lightcone-claude-code-origin-story-2026-02\|Boris Cherny raconte la genèse de Claude Code, philosophie produit et conseils fondateurs - Y Combinator Light Cone]]
- « 1 milliard USD ARR » (MESURE) — 0.80, DYNAMIQUE
...
- [[kb/_entites-mineures#RAG\|RAG]] (TECHNOLOGIE) — 0.88, DYNAMIQUE
...
- [[kb/subagents\|subagents]] (TECHNOLOGIE) — 0.99, DYNAMIQUE
...
- [[kb/Anthropic\|Anthropic]] **a_créé** → Claude Code — 0.99
- [[kb/Boris-Cherny\|Boris Cherny]] **a_créé** → Claude Code — 0.99
- [[kb/Mistral-AI-CLI\|Mistral AI CLI]] **concurrence** → Claude Code — 0.99
