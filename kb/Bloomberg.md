...
- **attribut** : 9000 ingénieurs, codebase massive
- **secteur** : Finance / Données de marché
...
- [[kb/_entites-mineures#BloombergGPT\|BloombergGPT]] (TECHNOLOGIE) — 0.95, STATIQUE
...
- [[kb/_entites-mineures#9000-ingénieurs\|9000 ingénieurs]] (CONCEPT) — 0.97, DYNAMIQUE
  - [[fiches/2025-11/zhang-bloomberg-deploying-ai-engineering-2025-11-23\|Bloomberg - Enterprise AI Deployment - Platform Engineering - Paved Path - Uplift Agents]]

## Relations (comme objet)

- [[kb/_entites-mineures#Lei-Zhang\|Lei Zhang]] **travaille_chez** → Bloomberg — 0.98
