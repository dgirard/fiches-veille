...
- **catégorie** : modèle de langage spécialisé extraction JSON
- **taille** : 0.5B à 7B paramètres
...
- [[kb/_entites-mineures#NuMind\|NuMind]] **a_créé** → NuExtract — 0.98
- [[kb/_entites-mineures#Alexandre-Constantin\|Alexandre Constantin]] **a_créé** → NuExtract — 0.95
- [[kb/_entites-mineures#Etienne-Bernard\|Etienne Bernard]] **a_créé** → NuExtract — 0.95
- [[kb/_entites-mineures#Liam-Cripwell\|Liam Cripwell]] **a_créé** → NuExtract — 0.95
