...
> **Type** : TECHNOLOGIE | 26 relations | 7 fiches sources
...
- [[kb/Cursor\|Cursor]] (TECHNOLOGIE) — 0.98, DYNAMIQUE
...
- [[kb/Devin\|Devin]] (TECHNOLOGIE) — 0.98, DYNAMIQUE
  - [[fiches/2025-07/powered-by-claude-anthropic-partners-2025-07-09\|Powered by Claude - Partenaires Anthropic - AI integrations - Ecosystem Claude - Applications]]
- [[kb/Replit\|Replit]] (TECHNOLOGIE) — 0.98, DYNAMIQUE
  - [[fiches/2025-07/powered-by-claude-anthropic-partners-2025-07-09\|Powered by Claude - Partenaires Anthropic - AI integrations - Ecosystem Claude - Applications]]
- [[kb/CodeRabbit\|CodeRabbit]] (TECHNOLOGIE) — 0.97, DYNAMIQUE
  - [[fiches/2025-07/powered-by-claude-anthropic-partners-2025-07-09\|Powered by Claude - Partenaires Anthropic - AI integrations - Ecosystem Claude - Applications]]
- [[kb/_entites-mineures#Harvey\|Harvey]] (TECHNOLOGIE) — 0.97, DYNAMIQUE
  - [[fiches/2025-07/powered-by-claude-anthropic-partners-2025-07-09\|Powered by Claude - Partenaires Anthropic - AI integrations - Ecosystem Claude - Applications]]

### améliore_performance_avec

- [[kb/_entites-mineures#temps-de-raisonnement\|temps de raisonnement]] (CONCEPT) — 0.92, ATEMPOREL
...
- [[kb/_entites-mineures#novembre-2025-après-lock-budgets-2026\|novembre 2025 après lock budgets 2026]] (EVENEMENT) — 0.93, STATIQUE
...
- [[kb/_entites-mineures#choix-sûrs-sans-guidance\|choix sûrs sans guidance]] (CONCEPT) — 0.92, ATEMPOREL
...
- [[kb/Agent-Skills\|Agent Skills]] **étend_les_capacités_de** → Claude — 0.99
- [[kb/Anthropic\|Anthropic]] **a_utilisé** → Claude — 0.98
- [[kb/Anthropic\|Anthropic]] **développe** → Claude — 0.98
- [[kb/Augment-Code\|Augment Code]] **est_basé_sur** → Claude — 0.97
- [[kb/Manus\|Manus]] **est_basé_sur** → Claude — 0.97
- [[kb/David-Thomas\|David Thomas]] **a_utilisé** → Claude — 0.95
- [[kb/_entites-mineures#Linear-MCP\|Linear MCP]] **connecte** → Claude — 0.95
- [[kb/Anthropic\|Anthropic]] **positionne** → Claude — 0.95
- [[kb/Ethan-Mollick\|Ethan Mollick]] **recommande** → Claude — 0.95
- [[kb/Anthropic-Interviewer\|Anthropic Interviewer]] **utilise** → Claude — 0.95
- [[kb/Weave\|Weave]] **intègre** → Claude — 0.92
- [[kb/_entites-mineures#Snowflake\|Snowflake]] **collabore_avec** → Claude — 0.90
