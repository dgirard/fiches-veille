...
- [[kb/_entites-mineures#loop\|/loop]] — description: Slash-command Claude Code utilisant cron pour planifier des repeat jobs (every minute/5min/day) — primitive d'architecture agentique (1 occ., 1 fiches)
...
- [[kb/AGI-technologie\|AGI]] — définition: IA surpassant humains dans toutes tâches (1 occ., 4 fiches)
- [[kb/AI\|AI]] — rôle: Objet du ressentiment populaire décrit par l'article, distinct du mouvement politique qu'il nourrit (4 occ., 4 fiches)
...
- [[kb/AI4Ops-technologie\|AI4Ops]] — résultat: 100% automatisation support N1, réduction >90% coûts (1 occ., 2 fiches)
...
- [[kb/_entites-mineures#Agentic-AI-Foundation\|Agentic AI Foundation]] — historique: Fondation Linux Foundation annoncée déc. 2025 ; projets fondateurs MCP (Anthropic), goose (Block), AGENTS.md (OpenAI) ; AWS/Google/Microsoft membres platine ; A2A versé par Google (1 occ., 2 fiches)
...
- [[kb/Augment-Code-technologie\|Augment Code]] — catégorie: Outil de développement IA (1 occ., 3 fiches)
...
- [[kb/CLAUDE-md-technologie\|CLAUDE.md]] — fonction: Fichier de configuration des instructions Claude Code (11 occ., 13 fiches)
...
- [[kb/_entites-mineures#Cash-App\|Cash App]] — rôle: Application de paiement grand public de Block ; support de Moneybot et du boîtier NFC Tags (2 occ., 2 fiches)
- [[kb/ChatGPT\|ChatGPT]] — évolution: Ajout de liens cliquables et éléments de recherche traditionnels (10 occ., 10 fiches)
...
- [[kb/Claude-entite\|Claude]] — catégorie: Modèle de langage (11 occ., 11 fiches)
...
- [[kb/Claude-Fable-5\|Claude Fable 5]] — catégorie: Modèle de fondation classe Mythos, usage général (7 occ., 6 fiches)
...
- [[kb/DeepSeek-technologie\|DeepSeek]] — catégorie: Modèle open-weights chinois (part doublée sur OpenRouter) (2 occ., 5 fiches)
...
- [[kb/_entites-mineures#Gemini-2.0-Flash-Lite\|Gemini 2.0 Flash-Lite]] — rôle: Génération précédente servant de point de comparaison de qualité et de latence (1 occ., 1 fiches)
- [[kb/_entites-mineures#Gemini-2.5\|Gemini 2.5]] — capacité: 1M tokens de contexte (1 occ., 1 fiches)
- [[kb/Gemini-2.5-Flash\|Gemini 2.5 Flash]] — fournisseur: Google (4 occ., 4 fiches)
...
- [[kb/Gemini-3.8-Flash\|Gemini 3.8 Flash]] — profil: Raisonnement proche de la frontière, forte vélocité, 0,75 $ / 3,75 $ par million de tokens, thinkingLevel réglable ; utilisable dès activation (1 occ., 1 fiches)
- [[kb/Gemini-CLI\|Gemini CLI]] — catégorie: Interface ligne de commande IA (5 occ., 5 fiches)
...
- [[kb/_entites-mineures#IndexShare\|IndexShare]] — rôle: Composant de traitement efficace du contexte long, publié par Z.ai avec GLM-5.2 (arXiv 2603.12201), pilier de la pile réutilisée pour GLM-5.3 (1 occ., 1 fiches)
...
- [[kb/LLM\|LLM]] — catégorie: Brique générative de la Software 3.0, distincte des bases de connaissances qui l'alimentent (3 occ., 3 fiches)
...
- [[kb/_entites-mineures#Lakana-360\|Lakana 360]] — nature: Plateforme d'interception nationale pour le renseignement malien, conçue avec Claude, déployée sur site avec un LLM local (1 occ., 1 fiches)
- [[kb/LangChain-technologie\|LangChain]] — usage: Framework prototypage agents IA (1 occ., 4 fiches)
...
- [[kb/_entites-mineures#MapReduce\|MapReduce]] — apport: Motif fonctionnel forçant les développeurs à exprimer le parallélisme explicitement ; l'auteur note qu'il s'agit plutôt de map/group-by-and-aggregate (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#Model-Garden\|Model Garden]] — nature: Catalogue de modèles managés de la plateforme, incluant Google, Anthropic, xAI et les modèles Hugging Face à déployer soi-même (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#MonetDB\|MonetDB]] — apport: Travaux du CWI ayant déplacé l'exécution de requêtes vers des lots de valeurs tenant en cache, le goulot étant passé du disque au CPU (1 occ., 1 fiches)
...
- [[kb/Nostr\|Nostr]] — définition: Protocole ouvert de messages signés et d'identités portables, où une identité est une paire de clés ; sert de substrat à Buzz pour signer messages, autorisations d'agents, approbations de workflow, commits et merges avec la même identité (4 occ., 4 fiches)
...
- [[kb/Nova\|Nova]] — catégorie: Plateforme d'agents de codage interne Dropbox (2 occ., 1 fiches)
...
- [[kb/_entites-mineures#PentAGI\|PentAGI]] — catégorie: Framework offensif agentique public reproduisant le scaffolding d'attaque autonome (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#Portal-by-Spotify\|Portal by Spotify]] — nature: Plateforme interne exposant des agents déclaratifs (AiKA Modes), une CLI et une API ; instance par organisation (1 occ., 1 fiches)
...
- [[kb/Qodo-technologie\|Qodo]] — catégorie: Agent de revue de code IA (1 occ., 2 fiches)
...
- [[kb/_entites-mineures#Qwen\|Qwen]] — statut: Versions 3.5, 3.6 et 3.7 déclarées entraînées sur des traces de raisonnement extraites d'Opus 4.6 et 4.7 (1 occ., 1 fiches)
...
- [[kb/Replit-technologie\|Replit]] — secteur: Développement web sans installation (3 occ., 6 fiches)
...
- [[kb/_entites-mineures#S3\|S3]] — contexte: Service de stockage objet d'AWS, étendu par S3 Files, S3 Tables et S3 Vectors, dont l'équipe a observé l'embarquement de DuckDB chez ses clients (1 occ., 1 fiches)
- [[kb/_entites-mineures#S3-Tables\|S3 Tables]] — rôle: Primitive de stockage tabulaire de S3 bâtie sur Iceberg, motivée par les clients Spark adoptant Iceberg (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#SKILL-md\|SKILL.md]] — rôle: Fichier de configuration d'un skill (1 occ., 2 fiches)
...
- [[kb/STS-(Security-Token-Service)\|STS (Security Token Service)]] — catégorie: Service Uber d'émission de JWT short-lived, audience-scoped, single-hop — TTL en minutes, P99 latency <40ms (1 occ., 1 fiches)
- [[kb/_entites-mineures#SWE-Bench-Pro\|SWE-Bench Pro]] — catégorie: Benchmark agents codage, GLM-5.1 leader 58,4% (1 occ., 2 fiches)
...
- [[kb/Scaleway-technologie\|Scaleway]] — catégorie: Cloud provider européen (IaaS/PaaS, public cloud) (1 occ., 3 fiches)
...
- [[kb/Skills-Claude\|Skills Claude]] — catégorie: Système de contexte dynamique activé à la demande (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#Spark\|Spark]] — apport: Chaînage d'opérateurs à évaluation paresseuse et dataframes, décomposés par un planificateur en tâches distribuées (1 occ., 1 fiches)
- [[kb/_entites-mineures#Sphere\|Sphere]] — fonction: Reporting opérationnel self-service UDA-powered (1 occ., 1 fiches)
- [[kb/Spotify-technologie\|Spotify]] — exemple: Service de streaming musical au stade Marchandise (1 occ., 3 fiches)
...
- [[kb/Standardized-A2A-Client\|Standardized A2A Client]] — catégorie: SDK Uber implémentant l'A2A protocol, automatise les échanges STS et la propagation de l'actor chain — pattern *secure path = easiest path* (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#TLA+\|TLA+]] — catégorie: Langage de modélisation formelle (états, transitions, invariants) (2 occ., 2 fiches)
...
- [[kb/Thunder\|Thunder]] — rôle: Service Rust in-memory Kafka-fed, lookups sub-ms des posts in-network récents (1 occ., 1 fiches)
...
- [[kb/Vertex-AI\|Vertex AI]] — catégorie: Plateforme IA GCP (sélection multi-modèles) (4 occ., 4 fiches)
...
- [[kb/Voxtral-Small\|Voxtral Small]] — rôle: Variante 24 B de la famille Voxtral, destinée au déploiement à l'échelle (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#Xen\|Xen]] — contexte: Hyperviseur issu des travaux doctoraux de l'auteur, tirant parti de l'abondance de CPU, mémoire et réseau sur un serveur unique (1 occ., 1 fiches)
- [[kb/_entites-mineures#Yoga\|Yoga]] — usage: Système de layout pour terminal (Meta) (1 occ., 1 fiches)
- [[kb/YouTube-technologie\|YouTube]] — catégorie: Plateforme vidéo recommandée pour 2026 (2 occ., 3 fiches)
- [[kb/_entites-mineures#Z.ai-Code-Bench\|Z.ai Code Bench]] — définition: Benchmark interne et privé de Z.ai évaluant les agents de codage en scénarios utilisateur réalistes, dans des environnements de développement locaux complexes, sur deux dimensions : taux de complétion end-to-end et exactitude de checklist fine, à plusieurs niveaux d'effort. Porte la revendication centrale du billet (+50 % sur GLM-5.2). Privé par conception, pour limiter la contamination — donc non réplicable par un tiers (1 occ., 1 fiches)
- [[kb/_entites-mineures#Z.ai-Security-Disclosure-Ledger\|Z.ai Security Disclosure Ledger]] — définition: Registre de divulgation créé par Z.ai (août 2026) recensant les vulnérabilités trouvées par ses modèles : 2 436 constats suivis, 53 publiquement divulgués, 2 383 sous embargo, 1 097 de sévérité critique ou élevée, 269 projets open source touchés, plus ancienne faille introduite en 1981, durée de vie moyenne 26,6 ans. Enregistre projet affecté, sévérité, CVE le cas échéant et ancienneté. Le corps du billet qualifie les 1 097 de « medium-to-high » alors que la distribution du même encart donne critical 107 + high 990 (1 occ., 1 fiches)
- [[kb/_entites-mineures#ZCode\|ZCode]] — définition: Agent de codage maison de Z.ai (zcode.z.ai), positionné comme le meilleur véhicule pour GLM-5.3 : taux de cache revendiqué à plus de 98 % soit environ 30 % de tokens effectifs en plus, boost de quota 1,5× jusqu'au 31 août 2026, mode Goal qui planifie, code, teste et vérifie jusqu'à atteinte de la cible, et pilotage à distance des tâches longues via WeChat ou Feishu (1 occ., 1 fiches)
- [[kb/Zapier-technologie\|Zapier]] — catégorie: Plateforme no-code d'automatisation workflows (1 occ., 4 fiches)
...
- [[kb/_entites-mineures#bulk-reader\|bulk-reader]] — rôle: Mode public lisant un lot de fichiers encadrés en balises XML et répondant en puces structurées ; le corpus n'entre pas dans le contexte de Claude (1 occ., 1 fiches)
...
- [[kb/ce-compound\|ce:compound]] — description: Skill de documentation de solutions avec schema par track (2 occ., 2 fiches)
...
- [[kb/_entites-mineures#code-writer\|code-writer]] — rôle: Mode public générant du code à partir d'une spécification et d'un fichier de référence obligatoire ; sortie écrite sur disque, jamais vue par Claude (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#git\|git]] — rôle: Dépôts standards hébergés sur le relais, sans wrapper propriétaire (2 occ., 2 fiches)
- [[kb/git-worktrees-technologie\|git worktrees]] — usage: Copie isolée du dépôt permettant de faire tourner une reconstruction à côté de la version courante et de comparer les evals avant fusion (4 occ., 5 fiches)
- [[kb/goose\|goose]] — éditeur: Block, Inc. (10 occ., 8 fiches)
...
- [[kb/hooks\|hooks]] — rôle: Commandes déclenchées à des points fixes du cycle de vie de Claude Code, servant de portes dures indépendantes de la décision du modèle (3 occ., 3 fiches)
...
- [[kb/_entites-mineures#mécanismes-anti-distillation\|mécanismes anti-distillation]] — portée: Édition du contexte antérieur bloquée pour les comptes API créés à partir du 2026-09-01 (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#preserved-thinking\|preserved thinking]] — définition: Mécanisme de Fable 5.1 empêchant les nouveaux comptes API d'altérer system prompt, outils ou messages précédant le raisonnement (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#promptfoo\|promptfoo]] — usage: Pilote des exécutions d'agent (provider exec) pour comparer deux modèles sur les mêmes tâches, timeout 60 s (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#relais-Buzz\|relais Buzz]] — limite: Source de vérité unique — la souveraineté promise est un droit de sortie, pas une redondance (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#setPublisherModelConfig\|setPublisherModelConfig]] — usage: API v1beta1 fixant dataSharingEnabledProvider à ANTHROPIC au niveau projet ; 409 si déjà fait, 403 explicite sinon (1 occ., 1 fiches)
...
- [[kb/shunt\|shunt]] — architecture: Plugin Claude Code à trois couches : hooks PreToolUse de blocage, scripts bash d'appel à la CLI Portal, skills d'invocation ; dégrade gracieusement si la skill est ignorée (1 occ., 1 fiches)
...
- [[kb/_entites-mineures#thinking-signature\|thinking signature]] — rôle: Référence chiffrée renvoyée à la place du raisonnement brut pour limiter la distillation (1 occ., 1 fiches)
