...
> 804 entités de type TECHNOLOGIE
...
- [[kb/Claude-Fable-5.1\|Claude Fable 5.1]] — catégorie: Modèle de fondation, disponibilité générale, identifiant API claude-fable-5-1 (3 occ., 2 fiches)
...
- [[kb/subagents-technologie\|subagents]] — définition: Assistants IA spécialisés avec context window séparé (2 occ., 4 fiches)
