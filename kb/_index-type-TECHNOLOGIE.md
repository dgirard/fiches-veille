...
> 798 entités de type TECHNOLOGIE
...
- [[kb/Claude-Code\|Claude Code]] — atout: Suivi d'instructions, génération de code, utilisation d'outils (60 occ., 54 fiches)
...
- [[kb/MCP\|MCP]] — catégorie: Protocole d'outillage dont l'article fixe la pile minimale utile au workflow (17 occ., 14 fiches)
...
- [[kb/hooks\|hooks]] — rôle: Commandes déclenchées à des points fixes du cycle de vie de Claude Code, servant de portes dures indépendantes de la décision du modèle (2 occ., 2 fiches)
