...
- [[kb/Claude-Code\|Claude Code]] — atout: Suivi d'instructions, génération de code, utilisation d'outils (45 occ., 39 fiches)
...
- [[kb/Claude-Opus-4.6\|Claude Opus 4.6]] — catégorie: Modèle de langage frontier Anthropic (2 occ., 1 fiches)
...
- [[kb/_entites-mineures#Hermes\|Hermes]] — catégorie: Harnais d'agent de pointe (1 occ., 1 fiches)
...
- [[kb/LangGraph\|LangGraph]] — catégorie: Framework d'orchestration d'agents LangChain (2 occ., 2 fiches)
...
- [[kb/OpenClaw\|OpenClaw]] — catégorie: Harnais d'agent de pointe (2 occ., 2 fiches)
...
- [[kb/_entites-mineures#Terminal-Bench-2.0\|Terminal Bench 2.0]] — catégorie: Benchmark pour agents de codage (1 occ., 1 fiches)
...
- [[kb/ce-review\|ce:review]] — description: Skill de revue de code multi-persona avec scoring confiance (1 occ., 1 fiches)
