...
- **rôle** : Partenaire ; continuité du variable technology spend
- **secteur** : Standardisation FinOps / Linux Foundation
...
- [[kb/_entites-mineures#FinOps-for-AI-Overview\|FinOps for AI Overview]] (DOCUMENT) — 0.98, STATIQUE
  - [[fiches/2026-02/finops-foundation-finops-for-ai-overview-2026-02-17\|Guide officiel FinOps Foundation pour l'IA : token economics, KPIs, caching, prompt optimization, sélection de modèle et extension des 14 capacités du Framework FinOps aux services GenAI - FinOps Foundation]]

## Relations (comme objet)

- [[kb/Tokenomics-Foundation\|Tokenomics Foundation]] **collabore_avec** → FinOps Foundation — 0.95
