...
- [[kb/_entites-mineures#Harness-engineering-for-coding-agent-users\|Harness engineering for coding agent users]] (CONCEPT) — 0.99, STATIQUE
...
- [[kb/_entites-mineures#harness-engineering-côté-utilisateur\|harness engineering côté utilisateur]] (METHODOLOGIE) — 0.90, DYNAMIQUE
...
- [[kb/Thoughtworks\|Thoughtworks]] (ORGANISATION) — 0.98, DYNAMIQUE
  - [[fiches/2026-04/boeckeler-harness-engineering-coding-agents-2026-04-02\|Harness engineering : modèle mental pour construire la confiance dans les agents de codage via guides feedforward et capteurs feedback]]
