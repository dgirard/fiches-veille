...
- [[kb/SDLC\|SDLC]] (CONCEPT) — 0.95, DYNAMIQUE
...
- [[kb/_entites-mineures#pierre-philosophale-réalisée\|pierre philosophale réalisée]] (CONCEPT) — 0.92, ATEMPOREL
...
- « 70% du resultat atteint rapidement, 30% restants exigeant expertise » (MESURE) — 0.92, ATEMPOREL
...
- [[kb/_entites-mineures#nouveaux-parcours-de-carrière-des-développeurs\|nouveaux parcours de carrière des développeurs]] (CONCEPT) — 0.95, DYNAMIQUE
...
- [[kb/_entites-mineures#transmutation-du-sable-en-pensée\|transmutation du sable en pensée]] (CONCEPT) — 0.95, ATEMPOREL
  - [[fiches/2026-02/andreessen-lenny-podcast-ai-jobs-agi-2026-02\|Andreessen/Lenny Podcast : IA, emplois, AGI et avenir des programmeurs]]
- [[kb/_entites-mineures#amplification-écart-de-productivité-ingénieurs\|amplification écart de productivité ingénieurs]] (CONCEPT) — 0.92, DYNAMIQUE
...
- [[kb/_entites-mineures#accumulation-accélérée-de-dette-technique-sans-tests\|accumulation accélérée de dette technique sans tests]] (CONCEPT) — 0.90, ATEMPOREL
...
- [[kb/_entites-mineures#définition-de-l'ontologie-organisationnelle\|définition de l'ontologie organisationnelle]] (CONCEPT) — 0.90, ATEMPOREL
...
- [[kb/_entites-mineures#modèle-pricing-par-siège\|modèle pricing par siège]] (CONCEPT) — 0.85, DYNAMIQUE
  - [[fiches/2025-11/bord-northwestern-mutual-genbi-enterprise-2025-11-23\|Construire la GenBI dans une entreprise Fortune 100 averse au risque (Northwestern Mutual) : petits paris, déploiement incrémental, agents spécialisés et démocratisation des données]]

## Relations (comme objet)

- [[kb/personal-software\|personal software]] **est_basé_sur** → IA — 0.95
- [[kb/_entites-mineures#travailleurs-américains\|travailleurs américains]] **utilise** → IA — 0.93
