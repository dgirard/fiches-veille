...
| Lattice | TECHNOLOGIE | est_basé_sur | Architecture trois-tiers Lattice | CONCEPT | 0.97 | ATEMPOREL | déclaré_article |
| Atoms (Lattice) | CONCEPT | est_instance_de | guardrails mono-principe | CONCEPT | 0.96 | ATEMPOREL | déclaré_article |
| Molecules (Lattice) | CONCEPT | utilise | Atoms (Lattice) | CONCEPT | 0.96 | ATEMPOREL | déclaré_article |
| Refiners (Lattice) | CONCEPT | affine | Atoms (Lattice) | CONCEPT | 0.95 | ATEMPOREL | déclaré_article |
| Pipeline Lattice | METHODOLOGIE | est_basé_sur | Pipeline Lattice | CONCEPT | 0.96 | ATEMPOREL | déclaré_article |
...
| Lattice | TECHNOLOGIE | fait_partie_de | Famille skills frameworks 2026 | CONCEPT | 0.94 | DYNAMIQUE | inféré |
...
| Lattice | TECHNOLOGIE | converge_avec | Convergence Lattice ↔ Compound Engineering | METHODOLOGIE | 0.93 | ATEMPOREL | inféré |
| Pipeline Lattice | METHODOLOGIE | converge_avec | pipeline ce:brainstorm → ce:plan → ce:work → ce:review (isomorphisme) | METHODOLOGIE | 0.91 | ATEMPOREL | inféré |
