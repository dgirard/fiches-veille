...
| Claude Fable 5 | TECHNOLOGIE | surpasse | Claude Opus 4.8 (capacité) au prix de $10/$50 le M tokens, soit 2× | MESURE | 0.9 | STATIQUE | déclaré_article |
| Arthur Mensch | PERSONNE | affirme_que | ~10 % du budget salarial est alloué aux tokens chez les adopteurs avancés | AFFIRMATION | 0.85 | DYNAMIQUE | déclaré_article |
| Didier Girard | PERSONNE | recommande | financer l'AI4IT d'abord (ROI prouvé, payback < 1 an) | AFFIRMATION | 0.95 | ATEMPOREL | déclaré_article |
| Didier Girard | PERSONNE | recommande | piloter le budget 2027 au coût par outcome plutôt qu'au prix du token | AFFIRMATION | 0.95 | ATEMPOREL | déclaré_article |
| Didier Girard | PERSONNE | recommande | redéfinir la comptabilité des effectifs (humains + agents) | AFFIRMATION | 0.9 | DYNAMIQUE | déclaré_article |

### Entités

| Entité | Type | Attribut | Valeur | Action |
|--------|------|----------|--------|--------|
| Didier Girard | PERSONNE | rôle | Managing Director (CTO/DG) de SFEIR ; auteur de l'article | MISE_A_JOUR |
| SFEIR | ORGANISATION | positionnement | Thèse AI4IT > AI4Business ; FinOps de l'usine logicielle | AJOUT |
| AI4IT | CONCEPT | définition | IA appliquée à la production du système d'information (code, SDLC, usine logicielle) | AJOUT |
| AI4Business | CONCEPT | définition | IA déversée dans les processus métier (ventes, support, finance, opérations) | AJOUT |
| coût par outcome | CONCEPT | définition | Piloter le budget IA au coût d'un résultat (ticket résolu, feature livrée), pas au décompte de tokens | AJOUT |
| renversement AI4IT / AI4Business | CONCEPT | définition | Inversion 2024→2026 : la valeur prouvée migre des processus métier vers la production logicielle | AJOUT |
| Claude Fable 5 | TECHNOLOGIE | tarif | $10 / $50 le M tokens (entrée/sortie) — 2× Opus 4.8 | AJOUT |
| Claude Opus 4.8 | TECHNOLOGIE | tarif | $5 / $25 le M tokens (entrée/sortie) | AJOUT |
| GLM-5.2 | TECHNOLOGIE | tarif | ~$1,40 / $4,40 le M tokens ; ~1/6 du frontier ; poids ouverts (MIT) | AJOUT |
| Arthur Mensch | PERSONNE | rôle | Cofondateur & CEO de Mistral AI ; audition Assemblée nationale (mai 2026) | AJOUT |
| J-courbe de la valeur IA | CONCEPT | définition | Creux temporaire de productivité (taxe de transition) avant la pente ascendante | AJOUT |
