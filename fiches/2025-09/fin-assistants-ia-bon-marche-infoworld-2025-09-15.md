...
|--------|------|----------|--------|--------|
| Cursor | TECHNOLOGIE | catégorie | Outil de vibe coding / assistant de codage IA | AJOUT |
| Claude Code | TECHNOLOGIE | catégorie | Outil de vibe coding / assistant de codage IA | AJOUT |
| Kiro | TECHNOLOGIE | catégorie | Outil de vibe coding / assistant de codage IA | AJOUT |
| Dion Hinchcliffe | PERSONNE | rôle | Lead CIO practice, The Futurum Group | AJOUT |
| Wei Zhou | PERSONNE | rôle | Head of AI utility research, SemiAnalysis | AJOUT |
| Charlie Dai | PERSONNE | rôle | VP et analyste principal, Forrester | AJOUT |
| Bradley Shimmin | PERSONNE | rôle | Lead data intelligence and analytics practice, The Futurum Group | AJOUT |
| The Futurum Group | ORGANISATION | secteur | Analyse / Conseil IT | AJOUT |
