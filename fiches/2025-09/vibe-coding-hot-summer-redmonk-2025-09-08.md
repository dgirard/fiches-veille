...
| Michael Truell | PERSONNE | rôle | CEO de Cursor | AJOUT |
| Replit | ORGANISATION | secteur | Plateforme SaaS de vibe coding | AJOUT |
| MCP | TECHNOLOGIE | forme_longue | Model Context Protocol | AJOUT |
| Cognition | ORGANISATION | produit_phare | Devin | AJOUT |
| Windsurf | TECHNOLOGIE | statut | Acquis par Cognition après tentative OpenAI / recrutement Google DeepMind | AJOUT |
| Google DeepMind | ORGANISATION | secteur | Recherche et produits IA | AJOUT |
| AWS | ORGANISATION | secteur | Cloud / Outils de développement | AJOUT |
| Kiro | TECHNOLOGIE | fonctionnalité | Mode "Vibe" et mode "Spec" intégrés | AJOUT |
