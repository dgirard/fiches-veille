...
## Titre Article
Live Agent Tracker - AI Agents we're building for our customers

## Date
2025-11-12 (consultation)

## URL
https://www.lyzr.ai/agent-tracker/

## Keywords
AI agents catalog, use cases, production agents, HR agents, marketing agents, banking agents, finance agents, customer service agents, healthcare agents, insurance agents, legal agents, agent complexity, time to production, Meesho, Accenture, AirAsia, KYC automation, pitch deck evaluator, YouTube to shorts, content workflow, FDA compliance, claim processing, fraud detection, multi-channel support, exit interview, investment memo, teller assistant, diagnosis agent, OCR agent, research assistant, resource allocation
...
- **Agents en production** : 1M+
- **Enterprise customers** : 100+

**Distribution 34 agents catalogués**
- **Complexité Low** : 7 agents (21%)
- **Complexité Medium** : 18 agents (53%)
- **Complexité High** : 9 agents (26%)

**Clients mentionnés publiquement**
- **Meesho** : HR Help Desk (Travel industry)
- **Accenture** : YouTube to Shorts Generator (Media & Entertainment)
- **AirAsia** : Content Workflow Assistant (Travel)

**Répartition par catégorie**
- **HR** : 2 agents (HR Help Desk, Exit Interview)
- **Marketing** : 6 agents (YouTube Shorts, Content Workflow, AI Image, OCR, Product Recommendations, Video Avatar)
- **Banking** : 4 agents (Commercial POC, Corporate Insights, Teller Assistant, Customer Refund)
- **Finance** : 6 agents (Research, Company Finder, Pitch Deck Eval, Startup Eval, Investment Memo, Credit Tear Sheet)
- **Customer Service** : 5 agents (Multi-Channel, 24/7 Support, Onboarding, Re-engagement x2)
- **Healthcare** : 3 agents (Full Diagnosis, ER Cardiology, FDA Compliance)
- **Insurance** : 2 agents (Claims + Fraud, Video Avatar)
...
- **Diane** : HR specialist
- **Jeff** : Support specialist
- **Skott** : Marketing specialist
- **Jazon** : Sales specialist
- **Amadeo** : Banking specialist
- **Benjie** : Insurance specialist

**Agent Studio proposition**
- Build agents sans coding
- Platform mentionné : Responsible AI, Hallucination manager, Knowledge base, Orchestration as a Service, Agents as a Service, Knowledge graph
