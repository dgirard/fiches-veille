...
|-------|-----------|----------|-------|-----------|-----------|-------------|--------|
| Michele Catasta | PERSONNE | dirige | Replit | ORGANISATION | 0.95 | DYNAMIQUE | déclaré_article |
...
| agents troisième génération (B3) | TECHNOLOGIE | mesure | plus d'une heure d'autonomie | MESURE | 0.85 | STATIQUE | déclaré_article |
