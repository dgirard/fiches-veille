...
|--------|------|----------|--------|--------|
| Tony Seale | PERSONNE | rôle | Consultant knowledge graph, auteur | AJOUT |
| noyau ontologique | CONCEPT | catégorie | Structure conceptuelle fondamentale d'entreprise | AJOUT |
| Semantic Data Products | METHODOLOGIE | catégorie | Approche données comme actif valorisé | AJOUT |
| DPROD | TECHNOLOGIE | catégorie | Spécification ouverte pour data products sémantiques | AJOUT |
| Michael Schrage | PERSONNE | affiliation | MIT Sloan | AJOUT |
| David Kiron | PERSONNE | affiliation | MIT Sloan | AJOUT |
| MIT Sloan | ORGANISATION | secteur | Recherche management et technologie | AJOUT |
