...
|--------|------|----------|--------|--------|
| MIT NANDA | ORGANISATION | secteur | Recherche IA enterprise / Networked Agents and Decentralized AI | AJOUT |
| The GenAI Divide State of AI in Business 2025 | DOCUMENT | méthodologie | 52 interviews exécutives + 153 sondages + 300 déploiements analysés | AJOUT |
| GenAI Divide | CONCEPT | définition | Fossé empirique entre adoption massive (80%) et transformation business mesurable (5%) | AJOUT |
| Shadow AI economy | CONCEPT | définition | Usage massif (90% des employés) d'outils IA personnels non sanctionnés par l'employeur | AJOUT |
| Enterprise paradox | CONCEPT | définition | Les grandes entreprises mènent en volume de pilotes mais échouent en déploiement | AJOUT |
| Investment bias | CONCEPT | définition | Budgets IA orientés sales/marketing alors qu'operations/finance offrent un meilleur ROI | AJOUT |
| Implementation advantage | CONCEPT | définition | Les outils vendors externes réussissent 2x plus souvent que les builds internes | AJOUT |
