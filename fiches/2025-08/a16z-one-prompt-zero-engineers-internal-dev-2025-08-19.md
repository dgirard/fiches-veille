...
|--------|------|----------|--------|--------|
| Gabriel Vasquez | PERSONNE | rôle | Investment Partner, Andreessen Horowitz (Enterprise & Fintech) | AJOUT |
| Stephenie Zhang | PERSONNE | rôle | Partner Growth investing, Andreessen Horowitz (Enterprise tech) | AJOUT |
| Yoko Li | PERSONNE | rôle | Partner, Andreessen Horowitz (Enterprise & Infrastructure) | AJOUT |
| Andreessen Horowitz | ORGANISATION | secteur | Capital-risque / VC technologie | AJOUT |
| Replit | TECHNOLOGIE | catégorie | Plateforme Gen AI app builder / IDE en ligne | AJOUT |
| Lovable | TECHNOLOGIE | catégorie | Plateforme Gen AI app builder (UI/design) | AJOUT |
| Retool | TECHNOLOGIE | catégorie | Plateforme low-code pour développeurs | AJOUT |
| Zapier | TECHNOLOGIE | catégorie | Plateforme no-code d'automatisation workflows | AJOUT |
| Sears Home Services | ORGANISATION | secteur | Services à domicile (utilisateur Replit) | AJOUT |
| Zillow | ORGANISATION | secteur | Immobilier / PropTech (utilisateur Replit) | AJOUT |
| Intuit | ORGANISATION | secteur | Logiciels financiers (utilisateur Lovable) | AJOUT |
| shadow IT | CONCEPT | description | Applications non gouvernées créées hors du contrôle IT | AJOUT |
| gouvernance | CONCEPT | description | Contrôle, audit et gestion des apps générées par IA | AJOUT |
