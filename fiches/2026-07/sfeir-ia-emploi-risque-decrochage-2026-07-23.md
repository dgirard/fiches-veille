...
notes: "Prise de parole éditoriale SFEIR (23 juil. 2026) qui adosse la doctrine SFEIR « amplifier plutôt que décrocher » à la note officielle de Bercy (Trésor-Éco n°391). Angles mobilisables en avant-vente / prise de parole DSI : (1) l'argument d'élasticité-prix (Jevons) est STRUCTURELLEMENT pro-emploi pour les développeurs — quand le code devient commodité, la valeur migre vers intention/architecture/contrôle ; (2) le signal 'juniors' (−16 %) est un avertissement organisationnel → former des ingénieurs augmentés (logique AI Champions) ; (3) le vrai risque de long terme est le décrochage compétitif (non-adoption), pas la destruction d'emplois ; (4) l'adoption précipitée produit du workslop → context engineering + gouvernance + critères POC→prod. Complète [[girard-sfeir-ai4it-vs-ai4business-budgets-2027-2026-06-24]] et commente [[dgtresor-ia-effets-emploi-2026-06-30]]."
...
| SFEIR | ORGANISATION | affirme_que | l'argument d'élasticité-prix est structurellement pro-emploi pour les développeurs | AFFIRMATION | 0.9 | DYNAMIQUE | déclaré_article |
| élasticité-prix de la demande | CONCEPT | permet | de déterminer l'effet emploi d'un métier, davantage que son exposition à l'IA | AFFIRMATION | 0.9 | ATEMPOREL | déclaré_article |
| IA générative | TECHNOLOGIE | réduit | l'emploi des juniors exposés (−16 % chez les 22-25 ans aux US) | MESURE | 0.85 | STATIQUE | déclaré_article |
| automatisation des tâches codifiées | CONCEPT | s_oppose_à | le renouvellement des expertises (formation des futurs seniors) | CONCEPT | 0.85 | DYNAMIQUE | déclaré_article |
| SFEIR | ORGANISATION | affirme_que | le scénario agentique, relégué en note de bas de page, pourrait invalider le cadre « assistant ponctuel » de la note | AFFIRMATION | 0.88 | DYNAMIQUE | déclaré_article |
| SFEIR | ORGANISATION | affirme_que | OpenAI et Anthropic, devenus sources de Bercy, produisent la donnée sur leur propre impact (biais de source non signalé) | AFFIRMATION | 0.87 | DYNAMIQUE | déclaré_article |
| labellisation | CONCEPT | observé_dans | 59 % des entreprises US qui invoquent l'IA pour justifier des gels d'embauche | MESURE | 0.85 | STATIQUE | déclaré_article |
| SFEIR | ORGANISATION | recommande | former des ingénieurs augmentés (programmes AI Champions) face au signal juniors | AFFIRMATION | 0.9 | ATEMPOREL | déclaré_article |
| SFEIR | ORGANISATION | recommande | encadrer l'adoption par le context engineering et une gouvernance de l'automatisable (éviter le workslop) | AFFIRMATION | 0.9 | ATEMPOREL | déclaré_article |
| adoption précipitée de l'IA | CONCEPT | s_oppose_à | qualité logicielle (produit du workslop et de la dette technique) | CONCEPT | 0.85 | ATEMPOREL | déclaré_article |
| code | CONCEPT | affirme_que | quand le code devient une commodité, la valeur migre vers l'intention, l'architecture et le contrôle | AFFIRMATION | 0.88 | ATEMPOREL | déclaré_article |

### Entités

| Entité | Type | Attribut | Valeur | Action |
|--------|------|----------|--------|--------|
| SFEIR | ORGANISATION | positionnement | « Amplifier l'IA plutôt que la subir » ; adoption comme levier vs pile de POCs | MISE_A_JOUR |
| IA et emploi : le vrai risque, c'est le décrochage | DOCUMENT | catégorie | Point de vue SFEIR (23 juil. 2026) commentant Trésor-Éco n°391 | AJOUT |
| décrochage compétitif | CONCEPT | définition | Risque de long terme des économies/entreprises qui tarderaient à adopter l'IA (compétitif avant d'être social) | AJOUT |
| paradoxe de Jevons | CONCEPT | application | Appliqué au code : coût moindre → demande de logiciel plus que proportionnelle (élasticité > 1) | MISE_A_JOUR |
| ingénieurs augmentés | CONCEPT | définition | Équipes montées d'un cran (de l'exécution vers jugement/spécification/validation) via l'outillage IA — logique AI Champions | AJOUT |
| AI Champions | METHODOLOGIE | définition | Programme SFEIR d'outillage des équipes pour amplifier l'IA (former des ingénieurs augmentés) | AJOUT |
| workslop | CONCEPT | définition | Sortie de faible valeur produite par une adoption IA sans méthode (dette technique à vitesse industrielle) | AJOUT |
| context engineering | METHODOLOGIE | rôle | Levier de trajectoire pour une adoption maîtrisée (gouvernance de l'automatisable, critères POC→prod) | AJOUT |
| labellisation | CONCEPT | mesure | 59 % des entreprises US invoquent l'IA pour justifier des gels d'embauche | AJOUT |
