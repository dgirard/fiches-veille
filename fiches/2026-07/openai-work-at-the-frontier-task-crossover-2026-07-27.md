---
themes: [transformation-adoption, economie-marche, recherche-education]
source: "OpenAI"
---
...
- **L'effet de taille est plus faible que rapporté ailleurs — deux réserves posées par OpenAI et souvent perdues** :
...
- **Réserves de fond, à porter systématiquement** :
...
OpenAI mesure l'usage de son propre produit, sur ses seuls utilisateurs américains, et présente cette position comme un atout.
...
|-------|-----------|----------|-------|-----------|-----------|-------------|--------|
| OpenAI Economic Research | ORGANISATION | publie | Work at the Frontier | DOCUMENT | 0.98 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | 16,8 % des messages liés au travail et 43,5 % des messages métier-spécifiques portent sur une tâche d'un autre métier | MESURE | 0.97 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | 61,5 % de l'usage professionnel est générique et écarté du calcul du crossover | MESURE | 0.95 | STATIQUE | déclaré_article |
| task crossover | CONCEPT | est_instance_de | l'apparition, dans l'usage IA d'un métier, de travail historiquement associé à un autre | CITATION | 0.97 | ATEMPOREL | déclaré_article |
| OpenAI Economic Research | ORGANISATION | s_oppose_à | les études qui partent d'une liste figée de tâches par métier pour tester la substituabilité du modèle | AFFIRMATION | 0.93 | ATEMPOREL | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | part hors métier par fonction : expérience client 77 %, design 75 %, RH 69 %, juridique 56 %, marketing 53 %, vente 40 %, finance 40 %, ingénierie 28 % | MESURE | 0.96 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | le design importe 35,2 % de tâches extérieures et n'en exporte que 1,7 % | MESURE | 0.95 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | l'ingénierie importe 18,5 % de tâches extérieures et en exporte 7,4 % | MESURE | 0.95 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | le marketing importe 24,3 % et exporte 8,9 %, la plus forte part sortante de l'échantillon | MESURE | 0.95 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | l'ingénierie retient 53 % de ses propres tâches, contre 11 % pour l'expérience client et 10 % pour les ressources humaines | MESURE | 0.92 | STATIQUE | déclaré_article |
| calcul financier | CONCEPT | observé_dans | le top 3 des tâches empruntées par les sept autres groupes de métiers | AFFIRMATION | 0.94 | STATIQUE | déclaré_article |
| dépannage technologique | CONCEPT | observé_dans | le top 3 des tâches empruntées par les sept autres groupes de métiers | AFFIRMATION | 0.94 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | la part hors métier passe de 18,9 % à 16,3 % selon la taille de l'espace de travail, chez les utilisateurs moyens seulement | MESURE | 0.95 | STATIQUE | déclaré_article |
| OpenAI Economic Research | ORGANISATION | affirme_que | la tendance liée à la taille de l'organisation n'est pas monotone chez les utilisateurs les plus intensifs | CITATION | 0.95 | STATIQUE | déclaré_article |
| OpenAI Economic Research | ORGANISATION | affirme_que | l'IA pourrait être particulièrement utile comme outil généraliste là où les ressources spécialisées manquent | AFFIRMATION | 0.9 | DYNAMIQUE | déclaré_article |
| données d'usage | CONCEPT | permet | de voir la recomposition des métiers avant la réécriture des fiches de poste et des intitulés | AFFIRMATION | 0.94 | ATEMPOREL | déclaré_article |
| Work at the Frontier | DOCUMENT | est_basé_sur | AI Jobs Transition Framework | DOCUMENT | 0.92 | STATIQUE | déclaré_article |
| AI Jobs Transition Framework | DOCUMENT | affirme_que | de nombreux métiers vont se réorganiser, leurs tâches quotidiennes pouvant changer substantiellement | AFFIRMATION | 0.92 | DYNAMIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | est_basé_sur | plus de 800 000 messages d'utilisateurs américains de ChatGPT | AFFIRMATION | 0.97 | STATIQUE | déclaré_article |
| OpenAI | ORGANISATION | affirme_que | sa position d'observation unique sur le monde du travail lui permet d'orienter la politique publique et la pratique | CITATION | 0.9 | DYNAMIQUE | déclaré_article |

### Entités

| Entité | Type | Attribut | Valeur | Action |
|--------|------|----------|--------|--------|
| Work at the Frontier | DOCUMENT | référence | OpenAI Economic Research, « How AI is Expanding What People Do at Work », premier rapport de la série, 27 juillet 2026 ; plus de 800 000 messages d'utilisateurs américains de ChatGPT ; rapport PDF associé | MISE_A_JOUR |
| task crossover | CONCEPT | mesure | 16,8 % des messages liés au travail et 43,5 % des messages métier-spécifiques, après retrait des 61,5 % d'usage générique | MISE_A_JOUR |
| OpenAI Economic Research | ORGANISATION | rôle | Équipe de recherche économique d'OpenAI ; mesure l'usage de son propre produit et revendique cette position comme un atout d'observation, avec une visée déclarée d'orientation des politiques publiques | MISE_A_JOUR |
