...
Article long format publié sur **X** (**11 août 2026**) par **Jesse Zhang**, CEO de **Decagon** (agents IA de service client). Titre en forme de dilemme shakespearien — *« To FDE, or not to FDE? »* — sur le **Forward Deployed Engineer**, devenu *« la réponse à presque toutes les questions difficiles du go-to-market IA »* : **Anthropic et OpenAI ont monté des bras de déploiement entreprise explicitement calqués sur Palantir**, et *« chaque boîte en seed »* affiche une offre d'emploi FDE ; les annonces pour ce titre seraient **en hausse de plusieurs centaines de pour cent en un an**. ⭐⭐ **Le sujet annoncé est un dilemme ; le vrai sujet est un test de sortie.** Zhang ne dit pas *« ne faites pas de FDE »* — il dit *« allez-y tôt, puis posez-vous la question de savoir si vous êtes encore en train de découvrir »*, et livre la ligne réutilisable : ***« Le piège, ce n'est pas de commencer. C'est de ne pas s'arrêter. »*** ⭐ **La généalogie Palantir est l'armature de l'argument** : la formule de **Shyam Sankar** (CTO), ***« FDEs eat pain and excrete product »*** — les FDE *digèrent la douleur et excrètent du produit* —, et le rappel de **Joe Lonsdale** que Palantir a passé près de deux décennies traitée de *« cabinet de conseil déguisé »*, sur la base d'une **observation exacte**. Les déploiements bespoke de **Gotham** (CIA, NSA, renseignement militaire) ont été **encodés en primitives de plateforme** — *ontologie, modèles d'objets, permissions, moteurs de workflow, traçabilité de provenance* — qui sont devenues **Foundry**, puis Apollo et AIP ; la standardisation a fait **monter la marge brute dans les 80 %** et Palantir est passée d'un motion FDE à une vente par comptes, beaucoup de FDE migrant vers l'ingénierie cœur. *« La douleur était l'intrant du produit, pas un coût de vente. »* ⭐ **La distinction que l'article introduit et que peu font** : **FDE ≠ implémentation**. *« Construire cette intégration dans leur système de ticketing »* est un travail réel mais **d'exécution contre une spec connue**, pas de **découverte d'une spec inconnue** ; confondre les deux *« est la façon dont une entreprise se convainc qu'une org de services qui grossit est un investissement produit »*. ⚠️ **Position d'énonciation à garder en tête** : c'est le **CEO d'un éditeur** qui plaide pour l'approche produit contre l'approche services — et son cofondateur **Ashwin Sreenivas vient de Palantir**. Les deux chiffres avancés sont **auto-déclarés, non définis et invérifiables** : *« deux tiers du travail de déploiement se fait désormais de façon autonome via **Duet** »* et *« quelques jours en moyenne pour lancer le premier AOP, même pour de grandes banques, compagnies aériennes, télécos »*. Le denominateur (*« travail de déploiement »*) n'est jamais défini, et le sigle **AOP n'est pas développé** dans le texte. La chute, elle, est citable : ***« Si vos FDE digèrent de la douleur et excrètent encore de la douleur, vous n'avez pas une équipe FDE. Vous avez une entreprise de services. »***
...
**Jesse Zhang** — cofondateur et **CEO de Decagon** (agents IA de service client, San Francisco), 85 000 abonnés sur X, site personnel `jessezhang.org`. Il cite son cofondateur **Ashwin Sreenivas** (**ex-Palantir**), d'où la profondeur du récit Palantir dans le texte.

⚠️ **Ce que la position d'énonciation implique.** Ce n'est ni une analyse de marché ni un retour d'expérience neutre : c'est un **dirigeant d'éditeur qui argumente pour le modèle économique de son propre produit**, dans un débat où l'alternative (FDE / services) est incarnée par des concurrents et des cabinets. La thèse — *« notre cœur de valeur, c'est d'avoir le meilleur produit »* — est **la position qu'il lui faut défendre**. Trois conséquences pratiques : (1) les **chiffres sont auto-déclarés** au public d'X, sans définition ni audit ; (2) le **cas Decagon est choisi**, et l'auteur reconnaît lui-même que son marché (*« service client : gros volume, répétable, décomposable »*) est particulièrement favorable à l'approche produit — ce qui **limite la portabilité** de la conclusion ; (3) le **récit Palantir est reconstruit rétrospectivement** à partir de sources publiques (Sankar, Lonsdale) et d'une expérience de seconde main. La partie **conceptuelle** de l'article (le test discovery/absorption, la distinction FDE ≠ implémentation) est indépendante de ces réserves et se cite pour elle-même ; la partie **empirique** ne se cite qu'attribuée.
...
- **⚠️ Les deux chiffres de l'article, et comment les citer.**
...
**Le cas Decagon.** Approche produit assumée, motivée par deux demandes constantes des entreprises : **vitesse d'itération** et **refus du verrouillage fournisseur**. Coût : transformer les escalades en exigences plutôt qu'en patchs. Bénéfice **auto-déclaré** : *« deux tiers du travail de déploiement »* réalisés de façon autonome via **Duet**, et *« quelques jours »* pour lancer le premier **AOP** chez de grandes banques, compagnies aériennes ou télécos. ⚠️ Chiffres non définis et invérifiables.
