...
notes: "Prise de parole éditoriale SFEIR (1er août 2026) qui adosse la bascule interne en Skill Based Organisation (Rosalie Zandona, VP People & Culture) à deux publications de juillet 2026 — l'expérience P&G « The Cybernetic Teammate » (Organization Science) et le premier rapport « Work at the Frontier » d'OpenAI Economic Research. Angles mobilisables en avant-vente RH/transformation : (1) le task crossover est un fait mesuré (43,5 % des messages métier-spécifiques sortent du métier de l'utilisateur), pas une projection — argument d'entrée chez un DRH ; (2) l'IA comme mécanisme de boundary-spanning (individu + IA = binôme sans IA, +0,37 SD) justifie de repenser l'unité d'organisation avant l'outillage ; (3) la fiche de poste comme unité obsolète → la compétence opérationnelle (jusqu'à 13 par métier chez SFEIR) ; (4) preuve par l'exemple interne (« nous avons fait la bascule chez nous avant de la conseiller »). RÉSERVES à porter en avant-vente : la SBO SFEIR date de février 2026, donc AVANT le diagnostic qu'elle est censée résoudre ; aucune donnée ne relie le crossover mesuré à la supériorité d'une organisation par compétences (hypothèse de conception, non testée) ; le chiffre Deloitte (98 %) est de la perception, pas de la performance. Complète [[sfeir-ia-emploi-risque-decrochage-2026-07-23]] sur le versant RH et prolonge [[mollick-organizational-theory-agentic-ai-spans-control-2026-02]]."
themes: [transformation-adoption, strategie-frameworks]
source: "SFEIR"
---
...
- **⚠️ Le maillon faible de la démonstration** : l'effet de taille repose sur **2,6 points d'écart** (18,9 % → 16,3 %), et ces valeurs ne sont **pas commensurables** avec les 43,5 % (base de calcul différente). La formule « l'IA tient le rôle du généraliste » est une **interprétation généreuse** d'un écart faible. À ne pas citer comme un résultat fort.
...
| The Cybernetic Teammate | DOCUMENT | mesure | les binômes sans IA identifient mieux leur meilleure idée (~50 % contre 37 % avec IA) | MESURE | 0.92 | STATIQUE | déclaré_article |
| jugement évaluatif humain | CONCEPT | s_oppose_à | la délégation complète de la sélection des idées à l'IA | AFFIRMATION | 0.85 | ATEMPOREL | inféré |
| Work at the Frontier | DOCUMENT | mesure | 43,5 % des messages spécifiques à un métier sortent du métier de l'utilisateur | MESURE | 0.95 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | task crossover par fonction : 77 % expérience client, 75 % design, 69 % RH, 28 % ingénierie | MESURE | 0.92 | STATIQUE | déclaré_article |
| Work at the Frontier | DOCUMENT | mesure | le design importe 35,2 % des tâches et n'en exporte que 1,7 %, l'ingénierie fait l'inverse | MESURE | 0.9 | STATIQUE | déclaré_article |
| task crossover | CONCEPT | observé_dans | les données d'usage de ChatGPT, comme signal avancé de la recomposition des métiers | AFFIRMATION | 0.9 | DYNAMIQUE | déclaré_article |
| OpenAI Economic Research | ORGANISATION | publie | Work at the Frontier | DOCUMENT | 0.95 | STATIQUE | déclaré_article |
| Ethan Mollick | PERSONNE | affirme_que | les frontières organisationnelles deviennent poreuses et les entreprises devront repenser la division du travail | AFFIRMATION | 0.93 | DYNAMIQUE | déclaré_article |
| Ethan Mollick | PERSONNE | affirme_que | correctement orchestrée, la recomposition du travail rapporte gros en satisfaction et en performance | AFFIRMATION | 0.9 | DYNAMIQUE | déclaré_article |
| Skill Based Organisation | METHODOLOGIE | remplace | la fiche de poste comme unité d'organisation du travail | AFFIRMATION | 0.93 | DYNAMIQUE | déclaré_article |
| SFEIR | ORGANISATION | utilise | Skill Based Organisation | METHODOLOGIE | 0.95 | DYNAMIQUE | déclaré_article |
| Rosalie Zandona | PERSONNE | travaille_chez | SFEIR | ORGANISATION | 0.95 | DYNAMIQUE | déclaré_article |
| Rosalie Zandona | PERSONNE | dirige | Skill Based Organisation | METHODOLOGIE | 0.9 | DYNAMIQUE | déclaré_article |
...
|--------|------|----------|--------|--------|
| SFEIR | ORGANISATION | organisation interne | Basculée en Skill Based Organisation (février 2026), jusqu'à 13 compétences identifiées par métier | MISE_A_JOUR |
| L'IA fait tomber les murs entre les métiers | DOCUMENT | catégorie | Point de vue SFEIR (1er août 2026) reliant l'expérience P&G et le rapport OpenAI à la bascule SBO du cabinet | AJOUT |
| Skill Based Organisation | METHODOLOGIE | définition | Modèle d'organisation faisant de la compétence réellement opérationnelle — et non du poste — l'unité de base du travail | AJOUT |
| compétence opérationnelle | CONCEPT | définition | Brique de base de la SBO : savoir-faire objectivé et transparent, déployé là où le besoin est concret, indépendamment de l'intitulé du poste (à ne pas confondre avec les Agent Skills) | AJOUT |
| task crossover | CONCEPT | définition | Tâches historiquement associées à un métier qui apparaissent dans l'usage IA de professionnels d'un autre métier ; mesuré à 43,5 % des messages métier-spécifiques | AJOUT |
| boundary-spanning | CONCEPT | définition | Mécanisme par lequel l'IA aide un professionnel à raisonner au-delà de son domaine d'origine, effaçant les silos fonctionnels | AJOUT |
| The Cybernetic Teammate | DOCUMENT | référence | Dell'Acqua, Ayoubi, Lifshitz, Sadun, E. Mollick, L. Mollick, Han, Goldman, Nair, Taub, Lakhani — Organization Science 37(4), 2026, p. 1217-1242 ; expérience préenregistrée chez P&G (791 prof. selon SFEIR, 776 dans le working paper NBER w33641 de mars 2025) | AJOUT |
| Work at the Frontier | DOCUMENT | référence | OpenAI Economic Research, « How AI is Expanding What People Do at Work », 1er rapport de la série, 27 juillet 2026 — plus de 800 000 messages d'utilisateurs américains de ChatGPT | AJOUT |
| Rosalie Zandona | PERSONNE | rôle | VP People & Culture chez SFEIR ; à l'origine de la bascule en Skill Based Organisation | AJOUT |
| Ethan Mollick | PERSONNE | rôle | Professeur à Wharton, co-auteur de « The Cybernetic Teammate » ; relie l'expérience P&G aux données d'usage OpenAI | MISE_A_JOUR |
| Procter & Gamble | ORGANISATION | rôle | Terrain de l'expérience « The Cybernetic Teammate » (professionnels R&D et commerce, défis d'innovation produit réels) | AJOUT |
| OpenAI Economic Research | ORGANISATION | rôle | Équipe de recherche économique d'OpenAI, éditrice de la série Work at the Frontier | AJOUT |
| identité opératoire | CONCEPT | définition | « Je sais concevoir des architectures complexes » — définition de soi par la compétence, opposée à l'identité statutaire (« je suis manager ») | AJOUT |
