...
| Interactions API | TECHNOLOGIE | utilise | MCP | TECHNOLOGIE | 0.93 | DYNAMIQUE | déclaré_article |
...
| Agent2Agent (A2A) | TECHNOLOGIE | utilise | Interactions API | TECHNOLOGIE | 0.90 | DYNAMIQUE | déclaré_article |
