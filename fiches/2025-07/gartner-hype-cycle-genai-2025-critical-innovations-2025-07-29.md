...
|-------|-----------|----------|-------|-----------|-----------|-------------|--------|
| Gartner | ORGANISATION | publie | Hype Cycle for Generative AI 2025 | DOCUMENT | 0.99 | STATIQUE | déclaré_article |
| Arun Chandrasekaran | PERSONNE | a_créé | Hype Cycle for Generative AI 2025 | DOCUMENT | 0.98 | STATIQUE | déclaré_article |
| Arun Chandrasekaran | PERSONNE | travaille_chez | Gartner | ORGANISATION | 0.97 | DYNAMIQUE | déclaré_article |
| Hype Cycle for Generative AI 2025 | DOCUMENT | prédit | 95% des entreprises utiliseront la GenAI en production d'ici 2028 | AFFIRMATION | 0.96 | STATIQUE | déclaré_article |
| LLMs | TECHNOLOGIE | fait_partie_de | GenAI models | CONCEPT | 0.95 | ATEMPOREL | déclaré_article |
| AI TRiSM | CONCEPT | améliore | sécurité et gouvernance IA | CONCEPT | 0.93 | ATEMPOREL | déclaré_article |
| Agentic AI | TECHNOLOGIE | remplace | chatbots passifs | TECHNOLOGIE | 0.91 | DYNAMIQUE | déclaré_article |
| self-supervised learning | METHODOLOGIE | réduit | besoin de données étiquetées | CONCEPT | 0.90 | ATEMPOREL | déclaré_article |
| AI engineering | METHODOLOGIE | améliore | déploiement à l'échelle GenAI | CONCEPT | 0.92 | ATEMPOREL | déclaré_article |
| Multimodal generative AI | TECHNOLOGIE | fait_partie_de | GenAI models | CONCEPT | 0.94 | STATIQUE | déclaré_article |
| Embodied AI | TECHNOLOGIE | fait_partie_de | AI agents | TECHNOLOGIE | 0.90 | STATIQUE | déclaré_article |
| AI supercomputing | TECHNOLOGIE | réduit | coûts entraînement et inférence modèles | CONCEPT | 0.87 | ATEMPOREL | déclaré_article |
| large reasoning models | TECHNOLOGIE | concurrence | LLMs | TECHNOLOGIE | 0.88 | DYNAMIQUE | déclaré_article |
...
| Hype Cycle for Generative AI 2025 | DOCUMENT | date | 2025-07-29 | AJOUT |
...
| Agentic AI | TECHNOLOGIE | description | IA autonome ou semi-autonome percevant, décidant et agissant | AJOUT |
| AI engineering | METHODOLOGIE | usage | Construction, gouvernance et personnalisation d'applications GenAI | AJOUT |
