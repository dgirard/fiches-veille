...
|--------|------|----------|--------|--------|
| Framework Leader-Lab-Crowd | METHODOLOGIE | structure | Trois cercles : dirigeants fluents, lab HR/business, masse des power users cachés | AJOUT |
| HR is R&D now | CONCEPT | définition | Formule de Mollick : la fonction RH devient l'unité de R&D organisationnelle de l'IA | AJOUT |
| Shadow AI | CONCEPT | définition | Usage massif de l'IA par les employés sans déclaration au management | AJOUT |
| AI-First Role Design | METHODOLOGIE | description | Avant d'écrire une fiche de poste, l'équipe RH passe 2h à augmenter le rôle avec l'IA | AJOUT |
| AI-Annotated Deliverables | METHODOLOGIE | description | Tout livrable interne accompagné d'une note d'usage IA et de valeur ajoutée | AJOUT |
| Weekly How Are You Using AI Ritual | METHODOLOGIE | description | 5 minutes hebdomadaires en réunion de direction pour partager les nouveaux usages IA | AJOUT |
| Performance Review Redesign | METHODOLOGIE | description | Refonte des reviews pour exploiter le feedback continu IA, pas juste l'écriture | AJOUT |
| Apprenticeship model collapse | CONCEPT | définition | Effondrement du pipeline implicite de formation par les tâches juniors automatisées | AJOUT |
| Valence | ORGANISATION | secteur | AI coaching pour entreprises Fortune 500 | AJOUT |
| Parker Mitchell | PERSONNE | rôle | CEO de Valence | AJOUT |
| Alex McMurray | PERSONNE | rôle | Cofounder et VP of Sales chez Valence | AJOUT |
| AI & the Workforce: The Adoption Gap | EVENEMENT | description | Sommet virtuel Valence avec keynote Mollick (juillet 2025) | AJOUT |
