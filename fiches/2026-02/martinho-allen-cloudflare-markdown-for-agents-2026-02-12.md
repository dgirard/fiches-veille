...
| Claude Code | TECHNOLOGIE | utilise | header Accept | CONCEPT | 0.95 | DYNAMIQUE | déclaré_article |
...
| MCP | TECHNOLOGIE | fait_partie_de | Toolshed | TECHNOLOGIE | 0.88 | DYNAMIQUE | déclaré_article |
| Cloudflare Radar | TECHNOLOGIE | mesure | utilisation par les crawlers IA | CONCEPT | 0.90 | DYNAMIQUE | déclaré_article |
...
| Markdown | TECHNOLOGIE | catégorie | Format de base dont Markdown for Agents fixe l'usage pour les agents | AJOUT |
