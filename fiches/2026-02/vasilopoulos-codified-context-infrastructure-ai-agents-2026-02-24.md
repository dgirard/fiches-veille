...
|-------|-----------|----------|-------|-----------|-----------|-------------|--------|
| Aristidis Vasilopoulos | PERSONNE | a_créé | infrastructure contexte codifié | METHODOLOGIE | 0.98 | STATIQUE | déclaré_article |
...
| infrastructure contexte codifié | CONCEPT | améliore | cohérence agents IA entre sessions | CONCEPT | 0.95 | ATEMPOREL | déclaré_article |
...
| Tier 2 Agents spécialisés | TECHNOLOGIE | fait_partie_de | infrastructure contexte codifié | METHODOLOGIE | 0.96 | ATEMPOREL | déclaré_article |
