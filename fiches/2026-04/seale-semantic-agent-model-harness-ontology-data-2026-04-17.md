...
|--------|------|----------|--------|--------|
| Tony Seale | PERSONNE | rôle | Évangéliste knowledge graph, auteur LinkedIn The Knowledge Graph Guy | MISE_A_JOUR |
| Semantic Agent | CONCEPT | définition | Agent combinant (modèle + harnais) et (ontologie + données) pour passer de la génération à la compréhension | AJOUT |
| Ontologie | CONCEPT | définition | Interface de compréhension de la donnée définissant entités, propriétés et relations | MISE_A_JOUR |
| Harnais d'agent | CONCEPT | définition | Tout ce qui n'est pas le modèle dans un agent, incluant outils et logique d'exécution | MISE_A_JOUR |
| Frameworks d'agents | TECHNOLOGIE | catégorie | Plateformes d'orchestration d'agents (état machine, routage, graphes) | AJOUT |
| LangGraph | TECHNOLOGIE | catégorie | Framework d'orchestration d'agents LangChain | AJOUT |
| CrewAI | TECHNOLOGIE | catégorie | Framework multi-agents collaboratifs | AJOUT |
| AutoGen | TECHNOLOGIE | catégorie | Framework multi-agents Microsoft | AJOUT |
| Semantic Kernel | TECHNOLOGIE | catégorie | Framework d'agents Microsoft | AJOUT |
| OpenAI Agents SDK | TECHNOLOGIE | catégorie | SDK d'agents OpenAI | AJOUT |
| AWS Bedrock | TECHNOLOGIE | catégorie | Plateforme IA/agents AWS | AJOUT |
| Google ADK | TECHNOLOGIE | catégorie | Agent Development Kit Google | AJOUT |
| OpenClaw | TECHNOLOGIE | catégorie | Harnais d'agent de pointe | AJOUT |
| Hermes | TECHNOLOGIE | catégorie | Harnais d'agent de pointe | AJOUT |
| Moat ontologique | CONCEPT | définition | Avantage compétitif durable par la connaissance structurée propre à l'organisation | AJOUT |
| Scaffolding | CONCEPT | définition | Structures de support transitoires autour des modèles qui doivent diminuer à mesure que l'intelligence augmente | AJOUT |
