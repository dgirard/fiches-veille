...
## Keywords
Jasmine Sun, NYT Opinion, permanent underclass, San Francisco consensus, AGI labor displacement, white-collar blood bath, Dario Amodei, Sam Altman, Chris Lehane, Jack Clark, Anthropic Institute, OpenAI Industrial Policy Intelligence Age, public wealth fund, 32-hour workweek, GDPVal, A.I. Productivity Index, Tejal Patwardhan, Jack Dorsey, Block layoffs, Opus 4.6, Codex 5.3, Anthropic 30B$ ARR, Mechanize startup, full automation economy, Anton Korinek, David Autor, Carl Benedikt Frey, short run lifetime, Yash Kadadi, Steven Adler, Zoë Hitzig, Bharat Ramamurti, Molly Kinder, Brookings, Alex Bores, Leading the Future PAC, Greg Brockman, David Shor poll, jobs guarantee, UBI unpopular, They work for the bots, Mark Kelly, Ro Khanna, Alex Karp, Sean O'Brien Teamsters, firebomb Altman home, data center attacks, Anthropic light and shade, junior engineers AI deskilling, China shock 2 years, last chance to be part of innovation, capital vs labor, federal jobs guarantee, AI populism

## Authors
Jasmine Sun (Ms. Sun écrit sur l'IA et la culture Silicon Valley sur Substack)

## Ton
**Profil** : Tribune-enquête longue (28 min de lecture audio) du New York Times Opinion, signée par une journaliste indépendante (Substack) ancrée à San Francisco. Format hybride entre l'éditorial argumenté et le reportage ethnographique : Sun ne se contente pas d'opiner, elle interview une vingtaine de personnes (PDG, économistes, lobbyistes, doomers, accelerationists, employés sous anonymat) et triangule dépêches publiques + échanges privés. Public cible : élite politique et médiatique américaine, lecteurs NYT classés center-left, candidats 2028, observateurs de la transition IA.

**Style** : Phrases élégantes, charpente argumentative serrée. Sun ouvre par un *aphorism-hook* qui fait office de thèse : *"Most people I know in the A.I. industry think the median person is screwed, and they have no idea what to do about it."* Elle alterne anecdotes ciselées (Yash Kadadi, 23 ans, Stanford dropout : *"this year is a human's last chance to be a part of the innovation"*), citations attribuées (*"You feel it in the fretting of recent college graduates who apply to hundreds of jobs without landing a single interview"*), données économiques précises (39% de la croissance US Q1-Q3 2025 = AI investments, St. Louis Fed) et observations ethnographiques fortes (*"Many engineers run several Claude Code agents simultaneously, giving them tasks to complete overnight so that someone — human or machine — is always on the clock. They muse about the postwork future while pulling 80-hour workweeks."*).

**Métaphores travaillées** : *"existential vertigo"*, *"the disco ball, with La Croix cans in hand"* (scène politique fundraiser), *"a remote co-worker who lives inside your computer"* (agents enterprise), *"the permanent underclass"* (terme repopularisé). Sun manie l'ironie sociologique fine : *"In general, tech industry sources expressed more extreme concern about the labor market impacts of A.I. in private conversation — but suddenly became optimists once I turned on the mic."*

**Position épistémique** : Sun n'est ni pessimiste catastrophiste ni techno-utopiste. Elle adopte la posture d'une *insider critic* qui prend au sérieux les inquiétudes des doomers tout en exigeant des engagements concrets des labs. Sa thèse principale est politique : *"the production of a social underclass is a policy choice"*. L'article pousse explicitement vers une fenêtre d'Overton élargie pour des politiques radicales (jobs guarantee, public wealth fund, AI taxes), pour qu'elles deviennent du capital de campagne 2028. Tonalité ferme et engagée mais sans dogmatisme : Sun cite généreusement les contre-arguments (Autor sur l'apparition de nouveaux métiers) tout en plantant la phrase de Frey qui clôt l'optimisme léger : *"the short run can be a lifetime."*

**Autorité** : construite par la combinaison NYT (institution) + accès Silicon Valley (sources internes labs, économistes, anciens responsables Biden, billionaires interviewés sous condition d'anonymat) + signature Substack (crédibilité indépendante). C'est un article-pivot qui **codifie le consensus SF 2026** sur le risque de déclassement et ouvre un cycle de debate politique autour de l'élection 2028.
...
- **Sam Altman** :
  ...
  - Solution proposée : taxer agressivement assets (terres + actions A.I.).
...
- **Données labor market** :
  ...
  - Hiring slow attendu : accounting, marketing, design, administrative work.
...
- **Articulation dossier veille** :
  ...
  - **Triangulation des chiffres** :
    - Anthropic ARR 30B$ (Sun) ↔ Stripe Minions 1300+ PRs/semaine (2026-02-19) — confirme le boom enterprise.
...
| A.I. Productivity Index | TECHNOLOGIE | définition | Benchmark mesurant 4 jobs : investment banking associate, management consultant, Big Law associate, primary care physician | AJOUT |
| Leading the Future PAC | ORGANISATION | description | Super PAC pro-IA financé en partie par Greg Brockman, 2M$+ contre Alex Bores | AJOUT |
| Alex Bores | PERSONNE | rôle | Candidat NY congressional, propose safety regulation IA + paiements directs financés par taxe IA | AJOUT |
| Mechanize | ORGANISATION | mission | Startup "to enable the full automation of the economy" | AJOUT |
| Block (layoffs mars 2026) | EVENEMENT | description | Jack Dorsey licencie ~50% effectifs, cite Opus 4.6 + Codex 5.3, +25% stock after-hours | AJOUT |
| Federal jobs guarantee | METHODOLOGIE | description | Politique populaire selon Shor, plus efficace que UBI pour répondre au permanent underclass | AJOUT |
| "They work for the bots. We work for you." | CONCEPT | source | Slogan top-performing dans les tests pubs de la firme Shor | AJOUT |
| Carl Benedikt Frey | PERSONNE | rôle | Économiste Oxford, auteur citation "the short run can be a lifetime" | AJOUT |
| Anton Korinek | PERSONNE | rôle | Économiste UVA + Anthropic Institute, thèse "no human job is invulnerable long-run" | AJOUT |
| David Autor | PERSONNE | rôle | Économiste MIT, thèse new industries will emerge (contrepoint underclass) | AJOUT |
| David Shor | PERSONNE | rôle | Pollster Démocrate, stratégiste messaging IA pour 2028 | AJOUT |
