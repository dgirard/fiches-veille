...
|--------|------|----------|--------|--------|
| Darragh Curran | PERSONNE | rôle | R&D leader Intercom, auteur de l'engagement public 2x productivité R&D en 12 mois | AJOUT |
| Intercom | ORGANISATION | échelle | 1305 employés, 500 R&D, 8,5M lignes code, 30 000 clients B2B, 313 deploys/jour, 2M+ QPS peak | AJOUT |
| 2x Principles (Curran) | METHODOLOGIE | description | Modern work methodology Intercom — annoncée mais détails réservés à un post suivant | AJOUT |
| Agent-first principle | CONCEPT | source | Décret Curran : "All technical work is becoming agent-first. This is the top priority for R&D." | AJOUT |
...
| Imperfect metrics doctrine | CONCEPT | source | Curran : "embrace potentially imperfect measures + monitor holistic outcomes" — anti-paralysie | AJOUT |
| Webinar 19 mai 2026 (Curran) | EVENEMENT | description | Webinar public Curran sur la stratégie AI transformation, 9h PT / 17h GMT | AJOUT |
