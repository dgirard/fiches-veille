...
|--------|------|----------|--------|--------|
| Kent Beck | PERSONNE | rôle | Co-auteur Manifeste Agile, créateur XP, analyste codage augmenté | MISE_A_JOUR |
| Kent Beck | PERSONNE | newsletter | Tidy First? (Substack) | AJOUT |
| Phase Expand | CONCEPT | description | Phase de croissance en escalier où l'on bute sur des ressources limitantes successives (modèle Explore/Expand/Extract) | AJOUT |
| Limites d'usage IA | CONCEPT | description | Plafonds imposés par fournisseurs IA segmentant utilisateurs en gratuit/premium/API | AJOUT |
