...
|--------|------|----------|--------|--------|
| Sierra | ORGANISATION | secteur | IA conversationnelle / Agents d'entreprise | AJOUT |
| Sierra | ORGANISATION | cofondateurs | Bret Taylor, Clay Bavor | AJOUT |
| Bret Taylor | PERSONNE | rôle | Co-fondateur et CEO de Sierra, président du conseil d'OpenAI | AJOUT |
| Onsite AI-native | METHODOLOGIE | description | Format d'entretien en 3 phases (Plan/Build/Review) remplaçant les entretiens de codage et algorithmes classiques | AJOUT |
| Phase Plan | METHODOLOGIE | description | Session d'idéation produit dirigée par le candidat dans son domaine d'expertise | AJOUT |
| Phase Build | METHODOLOGIE | description | 2 heures de construction autonome avec outils IA et frameworks au choix du candidat | AJOUT |
| Phase Review | METHODOLOGIE | description | Démo du produit construit, revue de code, discussion du chemin vers la production et usage de l'IA | AJOUT |
| Entretien de débogage | METHODOLOGIE | description | Revue et amélioration d'une codebase avec PR brouillon en itérant avec des agents de codage (pilote) | AJOUT |
| Codex | TECHNOLOGIE | catégorie | Agent de codage (OpenAI) | AJOUT |
| Claude Code | TECHNOLOGIE | catégorie | Agent de codage CLI (Anthropic) | MISE_A_JOUR |
