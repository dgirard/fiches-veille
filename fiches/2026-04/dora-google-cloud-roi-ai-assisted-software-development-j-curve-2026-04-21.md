...
| Eva Dong | PERSONNE | travaille_chez | Google Cloud | ORGANISATION | 0.95 | DYNAMIQUE | déclaré_article |
| Nathen Harvey | PERSONNE | dirige | DORA | ORGANISATION | 0.96 | DYNAMIQUE | déclaré_article |
| Ursula Lübbert-Passing | PERSONNE | travaille_chez | Google Cloud | ORGANISATION | 0.95 | DYNAMIQUE | déclaré_article |
...
| Learning curve | CONCEPT | fait_partie_de | J-Curve of AI value realization | CONCEPT | 0.95 | ATEMPOREL | déclaré_article |
| Verification tax | CONCEPT | fait_partie_de | J-Curve of AI value realization | CONCEPT | 0.95 | ATEMPOREL | déclaré_article |
| Pipeline adaptation | CONCEPT | fait_partie_de | J-Curve of AI value realization | CONCEPT | 0.95 | ATEMPOREL | déclaré_article |
...
| Productivity, User Experience, Cost Efficiency, Developer Experience, Business Growth | CONCEPT | fait_partie_de | Cinq piliers de valeur (DORA) | CONCEPT | 0.96 | ATEMPOREL | déclaré_article |
...
| Verification tax | CONCEPT | est_basé_sur | Code | CONCEPT | 0.95 | ATEMPOREL | déclaré_article |
| bilan ROI de l'étude | CONCEPT | converge_avec | Tatsyi production possibility frontier, Wescale gouvernance, Habert technology 20 / discipline 80 | CONCEPT | 0.93 | DYNAMIQUE | inféré |
| Ratios praticiens 3-5× (Frizzo, Wescale, Curran, Tatsyi) | CONCEPT | surpasse | Sample 12.5% time saved | CONCEPT | 0.93 | ATEMPOREL | inféré |
| Position no-headcount-reduction (DORA) | CONCEPT | s_oppose_à | Tatsyi −75 personnes mais réallocation délibérée | CONCEPT | 0.91 | DYNAMIQUE | inféré |
...
| ---------------------------------------------------------------------------- | ------------ | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| DORA | ORGANISATION | rôle        | Recherche software delivery performance, Google Cloud, lignée 2020 ROI DevOps → 2025 State of AI-assisted Software Development → 2026 ROI of AI-assisted Software Development                                                                                                       | AJOUT  |
| Google Cloud delta team                                                      | ORGANISATION | rôle        | Premier innovation practice Google Cloud Professional Services, agentic transformation end-to-end, value-driven model                                                                                                                                                               | AJOUT  |
| Eva Dong                                                                     | PERSONNE     | rôle        | AI Value Realization Lead Americas Google Cloud, ex-McKinsey 8 ans, Master Financial Engineering Michigan, co-auteur DORA ROI 2026                                                                                                                                                  | AJOUT  |
| Andre Ellis Jr.                                                              | PERSONNE     | rôle        | Cloud Financial Operations Lead Google Cloud, Morehouse College + Wharton MBA, co-auteur DORA ROI 2026                                                                                                                                                                              | AJOUT  |
| Nathen Harvey                                                                | PERSONNE     | rôle        | Lead DORA team Google Cloud, co-auteur multiples DORA reports + 97 Things Every Cloud Engineer Should Know (O'Reilly 2020)                                                                                                                                                          | AJOUT  |
| Vivian Hu                                                                    | PERSONNE     | rôle        | 10X Technology Consultant Google Cloud, contributrice DORA 2025 State of AI-assisted Software Development et DORA AI Capabilities Model                                                                                                                                             | AJOUT  |
| Ursula Lübbert-Passing | PERSONNE     | rôle        | AI Value Realization Lead EMEA Google Cloud, 20 ans benchmarking + value advisory, PhD effort estimation software projects                                                                                                                                                          | AJOUT  |
| Eric Maxwell                                                                 | PERSONNE     | rôle        | Lead 10X Technology consulting Google, ex-Chef Software, contributeur DORA team                                                                                                                                                                                                     | AJOUT  |
| Aaron Wanjala                                                                | PERSONNE     | rôle        | Cloud developer advocate Google Cloud, Spring Boot/Angular, app modernization + AI code assistance                                                                                                                                                                                  | AJOUT  |
| "AI is an amplifier"                                                         | CONCEPT      | source      | Thèse-pivot DORA ROI 2026 — l'IA magnifie forces et dysfonctionnements préexistants ; achat de licences ne suffit pas                                                                                                                                                               | AJOUT  |
...
| Cinq clés systémiques d'adoption                                             | CONCEPT      | définition  | Trust + Platform + Data + Users + Guardrails — capabilities organisationnelles qui transforment l'adoption en valeur financière                                                                                                                                                     | AJOUT  |
| IDP as product                                                               | CONCEPT      | définition  | Internal Developer Platform traité comme produit avec utilisateurs (devs ET agents IA), guardrails et UX réduisant cognitive load — primary connective tissue for AI value (DORA 2025 confirmé)                                                                                     | AJOUT  |
...
| AI | TECHNOLOGIE | rôle | Objet de l'étude ROI : amplificateur des forces et des faiblesses existantes d'une organisation | AJOUT |
| Code | CONCEPT | catégorie | Traité comme un passif à maintenir et non comme un actif produit — d'où la taxe de vérification | AJOUT |
| Google Cloud | ORGANISATION | rôle | Éditeur du rapport avec l'équipe DORA ; l'équipe delta en signe l'analyse économique | AJOUT |
