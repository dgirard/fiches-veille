...
| ---------------------------------------------------------------------------- | ------------ | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| DORA team                                                                    | ORGANISATION | rôle        | Recherche software delivery performance, Google Cloud, lignée 2020 ROI DevOps → 2025 State of AI-assisted Software Development → 2026 ROI of AI-assisted Software Development                                                                                                       | AJOUT  |
...
| Ursula Lübbert-Passing PhD                                                   | PERSONNE     | rôle        | AI Value Realization Lead EMEA Google Cloud, 20 ans benchmarking + value advisory, PhD effort estimation software projects                                                                                                                                                          | AJOUT  |
