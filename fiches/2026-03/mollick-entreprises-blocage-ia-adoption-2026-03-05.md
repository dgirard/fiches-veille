...
## Keywords
adoption IA, blocage entreprise, IT, juridique, gestion du risque, leadership, ChatGPT, Claude, Gemini, Claude Code, industries regulees, comite approbation, transformation numerique

## Authors
Ethan Mollick

## Ton
Profil : perspective d'observateur-expert, registre conversationnel-professionnel, niveau accessible. Ethan Mollick ecrit avec un ton de surprise mesuree et d'incredulite face a l'immobilisme de certaines entreprises. Il s'appuie sur son experience directe de terrain (consultations aupres d'entreprises) pour illustrer un contraste frappant entre deux types d'organisations. Le style est direct, factuel, avec une pointe d'ironie (la parenthese "they do not" qui demystifie une crainte infondee). Le commentaire additionnel de l'auteur adopte un ton analytique plus pose, identifiant la cause profonde comme une question de leadership et de volonte d'assumer le risque. Public cible : dirigeants d'entreprise, responsables IT et juridiques, professionnels interesses par la transformation IA.

## Pense-betes
- De nombreuses entreprises ont encore l'IA bloquee par les departements IT et juridique pour des raisons obsoletes
- Des entreprises dans des industries hautement regulees ont pourtant trouve des moyens de deployer ChatGPT, Claude et Gemini en version entreprise, y compris des CLIs comme Claude Code
- Fossé saisissant : dans une meme industrie, une entreprise utilise l'IA depuis 18 mois tandis qu'une autre a un comite qui doit approuver chaque cas d'usage individuellement
- Certaines entreprises craignent encore que les modeles actuels s'entrainent automatiquement sur leurs donnees (ce qui est faux)
- Le facteur decisif est generalement la volonte d'un dirigeant (souvent le CEO) d'assumer le risque et la responsabilite
- Si le dirigeant refuse d'assumer le risque, les forces de reduction du risque (IT, juridique) ont toutes les incitations a bloquer tout ce qui pourrait poser probleme
- C'est fondamentalement une question de leadership, pas une question technique

## RésuméDe400mots
Ethan Mollick, professeur associe a la Wharton School et auteur de Co-Intelligence, partage son etonnement face au nombre d'entreprises qui ont encore l'IA effectivement bloquee par leurs departements IT et juridique, et ce pour des raisons depassees. Il souligne le paradoxe : des entreprises operant dans des industries hautement regulees ont deja trouve des moyens de deployer des solutions d'IA d'entreprise comme ChatGPT, Claude et Gemini, y compris des outils en ligne de commande comme Claude Code, sans rencontrer de probleme apparent.
...
Ce post a genere un engagement massif (plus de 1 793 reactions, 288 commentaires, 149 repartages), temoignant de la resonance de ce constat aupres de la communaute professionnelle.
...
| Wharton School | ORGANISATION | secteur | Education / Business | AJOUT |
| ChatGPT | TECHNOLOGIE | categorie | IA generative enterprise | AJOUT |
| Claude | TECHNOLOGIE | categorie | IA generative enterprise | AJOUT |
| Gemini | TECHNOLOGIE | categorie | IA generative enterprise | AJOUT |
| Claude Code | TECHNOLOGIE | categorie | CLI agent de codage | AJOUT |
| Adoption IA en entreprise | CONCEPT | enjeu | Leadership et gestion du risque | AJOUT |
