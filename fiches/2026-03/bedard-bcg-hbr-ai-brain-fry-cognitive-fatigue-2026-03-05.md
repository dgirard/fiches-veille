...
|--------|------|----------|--------|--------|
| AI brain fry | CONCEPT | définition | Mental fatigue from excessive use or oversight of AI tools beyond one's cognitive capacity. Symptômes : buzzing, mental fog, slower decision-making, headaches | AJOUT |
| Julie Bedard | PERSONNE | rôle | Managing Director & Partner BCG, BCG Henderson Institute Fellow, lead author étude AI brain fry | AJOUT |
| Matthew Kropp | PERSONNE | rôle | Managing Director & Senior Partner BCG, CTO BCG X, BCG Henderson Institute Fellow | AJOUT |
| Megan Hsu | PERSONNE | rôle | Project Leader BCG, BCG Henderson Institute Ambassador | AJOUT |
| Olivia T. Karaman | PERSONNE | rôle | PhD candidate UC Riverside, Research Assistant BCG | AJOUT |
| Jason Hawes | PERSONNE | rôle | PhD candidate UC Riverside, Research Assistant BCG | AJOUT |
| Gabriella Rosen Kellerman | PERSONNE | rôle | Expert Partner & Director BCG, psychiatre, co-auteure Tomorrowmind | AJOUT |
| BCG Henderson Institute | ORGANISATION | secteur | Think tank de recherche BCG | AJOUT |
| Étude BCG HBR mars 2026 | DOCUMENT | méthodologie | 1 488 full-time US workers, 48% male / 51% female, 58% IC / 41% leaders, large companies, janvier 2026, design anti-priming | AJOUT |
| Burnout vs Brain fry | CONCEPT | distinction | Burnout = émotionnel (allégé par IA sur tâches répétitives -15%) ; Brain fry = cognitif aigu (aggravé par oversight intensif) | AJOUT |
| AI orphan tax | CONCEPT | définition | +5% mental fatigue chez les salariés dont le manager attend qu'ils se débrouillent seuls avec l'IA | AJOUT |
| Toil | CONCEPT | définition | Tâches routinières répétitives non plaisantes — cibles idéales de délégation à l'IA, source de réduction du burnout | AJOUT |
| Peak productivité 3 outils IA | CONCEPT | données | Productivité auto-rapportée : 1 outil 3.3 / 2 outils 3.8 / 3 outils 4.1 / 4+ outils 3.7. Décroissance après 3. | AJOUT |
| Steve Yegge | PERSONNE | rôle | Programmeur, créateur de Gas Town (1er janvier 2026), plateforme open source d'orchestration swarms Claude Code | MISE_A_JOUR |
| Gas Town | TECHNOLOGIE | définition | Plateforme open source d'orchestration de swarms d'agents Claude Code en parallèle. Lancée 1er janvier 2026 par Steve Yegge | AJOUT |
| Francesco Bonacci | PERSONNE | rôle | Engineer, founder Cua AI, auteur du post X viral "Vibe Coding Paralysis: When Infinite Productivity Breaks Your Brain" | AJOUT |
| Cua AI | ORGANISATION | secteur | Start-up IA fondée par Francesco Bonacci | AJOUT |
| Vibe Coding Paralysis | CONCEPT | définition | Concept Bonacci : épuisement non par le travail mais par sa gestion. 6 worktrees, 4 features à moitié, 2 quick fixes en rabbit holes | AJOUT |
| Tomorrowmind | DOCUMENT | type | Livre co-écrit par Gabriella Rosen Kellerman sur santé mentale et futur du travail | AJOUT |
| Token consumption performance metric | METHODOLOGIE | description | Pratique d'entreprise (ex: Meta avec lines of AI code) qui incite à maximiser l'usage IA — source d'épuisement | AJOUT |
| Problem framing / analysis planning / strategic prioritization | METHODOLOGIE | description | Trois skills BCG-identifiées qui débloquent les top users d'IA et préviennent l'épuisement | AJOUT |
| Harvard Business Review | ORGANISATION | secteur | Publication académique-business, Harvard Business School Publishing | MISE_A_JOUR |
